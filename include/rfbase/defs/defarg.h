...
#include <rfbase/preprocessor/rf_xmacro_argcount.h> //for RF_NARG argument count macro
#include <rfbase/preprocessor/rf_xmacro_gt.h>    //for the greater than macro token comparison
